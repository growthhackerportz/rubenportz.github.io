...
- On his live financial's have bubbles showcasing the features of the site. Similar to a tour of the product. 
- Highlight 3 key things about the service, effortless tracking, automatic categorization & instant saving offers. 
...
- Have metric dashboard in place (see metrics above). Structure code so ability to implement a/b testing and measurement of a/b results. 
...
- Contract with specific bloggers different verticals of information to have a library of content that will be indexed for seo and provide good resources for users. 
